  ...
  <el-container>
    <el-header height="61" class="student-header">
      ...
      <el-menu class="el-menu-title" mode="horizontal" :default-active="defaultUrl" :router="true">
        ...
        <el-menu-item index="/paper/index">Paper</el-menu-item>
        <el-menu-item index="/record/index">Assessment Record</el-menu-item>
      </el-menu>
      <div>
        <a href="/"><img src="@/assets/uosLogo.png" height="55"/></a>
        <span style="font-size:30px;padding-left: 30px"><strong>School of Electronics and Computer Science</strong></span>
      </div>
    </el-header>
